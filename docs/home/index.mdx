...
sidebar_label: LitMDX
description: LitMDX is an open-source documentation framework for React and MDX. Zero config, built-in full-text search, static site generation, and WebMCP support. Get your docs site running in minutes.
sidebar_position: 1
---
