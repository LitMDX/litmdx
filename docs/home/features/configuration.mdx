---
title: Configuration — LitMDX
description: Customize your LitMDX documentation site with litmdx.config.ts. Configure title, description, navigation, SEO, Open Graph, favicon, and more.
sidebar_position: 1
