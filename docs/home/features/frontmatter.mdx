---
title: Frontmatter
description: "Use YAML frontmatter in MDX files to control per-page SEO metadata (title, description, og:image, noindex, schema_type), sidebar order, labels, and visibility."
sidebar_position: 2
---
