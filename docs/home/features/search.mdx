---
title: Full-Text Search — LitMDX
description: LitMDX includes built-in full-text search powered by Pagefind. No server, no external API, no API key. Works entirely in the browser after a static build.
sidebar_position: 4
---
